...
public interface SubjectRepository extends JpaRepository<SubjectEntity, String> {
	...
	@Query("SELECT asig.code as code, asig.name as name, ca.definitiva as definitiva, ca.nota as nota , ca.revisada as revisada, ca.teacher.mail as teacher FROM SubjectEntity AS asig  "
